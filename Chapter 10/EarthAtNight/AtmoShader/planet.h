...
#define PLANET_BLEND_MODE_NONE              0
#define PLANET_BLEND_MODE_SOLID             1
#define PLANET_BLEND_MODE_FADE              2
#define PLANET_BLEND_MODE_ATMO              3
...
@private
    ...
    struct VAOInterleaved *m_InterleavedData;              
}
